...
import { createProcess } from '@/actions/ropa'
...
export function RopaForm({ departments }: RopaFormProps) {
  ...
  // Trigger SILIP consultation when title changes
  ...
  const onSubmit = async (data: ProcessFormData) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        alert(result.error || 'Failed to create process')
      }
    } catch (error) {
      console.error('Submission error:', error)
      alert('An error occurred while creating the process')
    } finally {
      ...
      <Tabs value={currentStep} onValueChange={setCurrentStep} className="w-full">
        ...
        <TabsContent value="basics" className="space-y-4 mt-6">
          ...
          <div className="space-y-2">
            ...
            <Select onValueChange={(value) => setValue('deptId', value)}>
              <SelectTrigger>
        ...
        <TabsContent value="purpose" className="space-y-4 mt-6">
          <div className="space-y-2">
            ...
            <Select onValueChange={(value) => setValue('lawfulBasis', value)}>
              <SelectTrigger>
